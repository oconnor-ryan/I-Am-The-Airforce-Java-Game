...
public class SmartShotGunJet extends SmartJet
{
	public SmartShotGunJet(Level l, int x, int y)
	{
		super(l,x,y);
		setScore(500);
	}
	...
	public void shoot()
	{
		...
		if(getDirection() == Right())
		{
			if(player.getX() - this.getX() > 0)
			{
				...
				addProjectile(new Bullet(getLevel(), getX() + getXSize() + 10, getY()+getYSize()/2, xVel1, yVel1, this));
				addProjectile(new Bullet(getLevel(), getX() + getXSize() + 10, getY()+getYSize()/2, xVel2, yVel2, this));
			}
		}
		else if(getDirection() == Left())
		{
			if(player.getX() - this.getX() < 0)
			{
				...
				addProjectile(new Bullet(getLevel(), getX() - 10, getY()+getYSize()/2, xVel1, yVel1, this));
				addProjectile(new Bullet(getLevel(), getX() - 10, getY()+getYSize()/2, xVel2, yVel2, this));
			}
		}
	}
}
